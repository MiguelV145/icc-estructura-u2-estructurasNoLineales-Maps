...
public class App {
    ...
    private static void runEmpleadoExample() {
        EmpleadoContoller empCtr= new EmpleadoContoller();
        empCtr.addEmpleados(new Empleado(1, "Carlos","Developer"));
        empCtr.addEmpleados(new Empleado(2, "Pablo","Analyst"));
        empCtr.addEmpleados(new Empleado(3, "José","Developer"));
        empCtr.addEmpleados(new Empleado(494, "Juan José","Tester"));

        empCtr.imprimirEmpleado();
    }
